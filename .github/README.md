...
[`@aws-sdk/client-vpc-lattice`](https://www.npmjs.com/package/@aws-sdk/client-vpc-lattice/v/3.1128.0).
...
- @aws-sdk/client-vpc-lattice v3.1128.0 - [https://cloud-sdk-builds.github.io/?sdk=client-vpc-lattice&version=3.1128.0](https://cloud-sdk-builds.github.io/?sdk=client-vpc-lattice&version=3.1128.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-vpc-lattice@3.1128.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sRVvNY1Av+CwgPdoLXiM8wDGS95T0NXeUhVKtHtvxp5S+FDvDFJVZsbq5bzxIvRk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-vpc-lattice": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-vpc-lattice@3.1128.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-vpc-lattice@3.1128.0/index.min.mjs": "sha384-sRVvNY1Av+CwgPdoLXiM8wDGS95T0NXeUhVKtHtvxp5S+FDvDFJVZsbq5bzxIvRk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-vpc-lattice/blob/refs/tags/3.1128.0/LICENSE
```
